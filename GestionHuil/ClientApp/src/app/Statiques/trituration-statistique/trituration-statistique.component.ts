...
@Component({
  selector: 'app-trituration-statistique',
  templateUrl: './trituration-statistique.component.html',
  styleUrls: ['./trituration-statistique.component.scss']
})
export class TriturationStatistiqueComponent implements OnInit , OnChanges  {
  ...
  constructor() {
    // this.Dataa = statistiqueService.getOption();
