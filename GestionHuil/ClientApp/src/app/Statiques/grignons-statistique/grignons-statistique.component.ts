...
@Component({
  selector: 'app-grignons-statistique',
  templateUrl: './grignons-statistique.component.html',
  styleUrls: ['./grignons-statistique.component.scss']
})
export class GrignonsStatistiqueComponent implements OnInit , OnChanges {
  @Input() myData: any;
  total: any = null;
  montant: any = null;
