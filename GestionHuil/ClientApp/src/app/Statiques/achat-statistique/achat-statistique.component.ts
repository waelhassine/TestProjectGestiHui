...
@Component({
  selector: 'app-achat-statistique',
  templateUrl: './achat-statistique.component.html',
  styleUrls: ['./achat-statistique.component.scss']
})
export class AchatStatistiqueComponent implements OnInit , OnChanges {
  @Input() myData: any;
  total: any = null;
  montant: any = null;
