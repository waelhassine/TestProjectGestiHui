...
export class TriturationService {
  ...
  private accessPointUrl = 'http://localhost:59948/api/trituration';
 ...
 public getAllStockNew(id) {
  return this.http.get(this.accessPointUrl + '/stockclient/' + id , {headers: this.headers});
 }
 public checkTriturationExitsFacture(id) {
  return this.http.get(this.accessPointUrl + '/check/' + id , {headers: this.headers});
 }
 public checkTriturationExitsAchat(id) {
  return this.http.get(this.accessPointUrl + '/checkachat/' + id , {headers: this.headers});
 }
