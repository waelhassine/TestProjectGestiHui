...
export class AchatService {
  ...
  private accessPointUrl = 'http://localhost:59948/api/achats';
 ...
 public getAllTrituration() {
  // Get all jogging data
  return this.http.get(this.accessPointUrl + '/trituration', {headers: this.headers});
}
public checkAchatExitsFacture(id) {
