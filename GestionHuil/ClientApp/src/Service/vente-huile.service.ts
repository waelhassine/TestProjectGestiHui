...
export class VenteHuileService {
  private headers: HttpHeaders;
  private accessPointUrl = 'http://localhost:59948/api/vente';
 ...
 public getAllVariete() {
  // Get all jogging data
  return this.http.get(this.accessPointUrl + '/variete', {headers: this.headers});
}
public getAllClients() {
  // Get all jogging data
  return this.http.get(this.accessPointUrl + '/clients', {headers: this.headers});
}
public checkVenteExitsFacture(id) {
